...
test("展示顺序按 基础 → 扩展集成 → 开发者工具 → 开发与维护 排列", () => {
	assert.deepEqual([...SETTINGS_TAB_LAYOUT.map((entry) => entry.id)], ["common", "shortcuts", "notification", "appearance", "terminal", "proxy", "im", "pet", "vision", "imagegen", "web", "editors", "git", "dev", "usage", "process", "storage", "backup"]);
});
