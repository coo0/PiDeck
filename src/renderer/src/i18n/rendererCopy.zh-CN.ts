...
export const zhCN = {
	...
	"settings.tabs.terminalDesc": "终端配色、字体与行为",
	"settings.terminal.appearance": "外观",
	"settings.terminal.font": "字体",
	"settings.terminal.behavior": "行为",
	"settings.terminal.startup": "启动",
	"settings.terminal.theme": "配色主题",
	"settings.terminal.themeDesc": "跟随应用明暗，或指定固定配色",
	"settings.terminal.theme.inherit": "跟随应用外观",
	"settings.terminal.paddingY": "内容区上下内边距",
	"settings.terminal.paddingYDesc": "终端内容与面板边界的上下留白（px）",
	"settings.terminal.fontSize": "字号",
	"settings.terminal.fontSizeDesc": "选择「跟随界面字号」则使用外观设置里的界面字号档",
	"settings.terminal.fontSize.follow": "跟随界面字号",
	"settings.terminal.fontFamily": "字体",
	"settings.terminal.fontFamilyDesc": "从系统已安装字体中选择；选「跟随代码字体」则使用外观设置里的代码字体",
	"settings.terminal.fontFamily.follow": "跟随代码字体",
	"settings.terminal.fontFamilySearch": "搜索字体…",
	"settings.terminal.fontFamilyEmpty": "没有匹配的字体",
	"settings.terminal.fontFamilyMissing": "当前值（系统未安装）",
	"settings.terminal.fontFamilyLoadFailed": "未能读取系统字体列表，暂时只能选择「跟随代码字体」。",
	"settings.terminal.scrollback": "滚动回放行数",
	"settings.terminal.scrollbackDesc": "保留的历史行数上限。改动后需新开终端才生效（缩小会立即丢弃历史，因此不做热更新）",
	"settings.terminal.cursorStyle": "光标形状",
	...
	"settings.terminal.copyOnSelectDesc": "在终端里选中文本时自动复制到系统剪贴板",
	"settings.terminal.confirmClose": "关闭确认",
	"settings.terminal.confirmCloseDesc": "关闭终端标签时的确认策略",
	"settings.terminal.confirmClose.never": "从不确认",
	"settings.terminal.confirmClose.running": "仅运行中确认",
	"settings.terminal.confirmClose.always": "总是确认",
	"settings.terminal.startupCommand": "启动命令",
	"settings.terminal.startupCommandDesc": "新终端在 shell 启动后自动执行该命令",
	"settings.terminal.startupCommandPlaceholder": "例如：cd ~/projects",
	"terminal.closeTabConfirm": "关闭这个终端？",
	"terminal.closeTabConfirmDesc": "该终端里可能有正在运行的任务，关闭会终止它们。",
	...
	"settings.updateSource": "内容更新源",
	"settings.updateSourceDesc": "选择下载模型目录、内置扩展、DSH runtime 等内容的网络通道。国内推荐 AtomGit，也可切换至 GitHub 官方通道。应用自身的更新固定走 GitHub，不受此项影响。",
	...
	"settings.updateSourceFeedPreview": "当前内容更新源地址：{url}",
	...
	"settings.updateGithubFailHint": "应用更新固定从 GitHub 拉取；若直连失败，可到 Release 页面手动下载安装包。",
