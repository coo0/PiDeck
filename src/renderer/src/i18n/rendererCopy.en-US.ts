...
export const enUS: Record<TranslationKey, string> = {
	...
	"settings.tabs.terminalDesc": "Terminal colors, fonts and behavior",
	"settings.terminal.appearance": "Appearance",
	"settings.terminal.font": "Font",
	"settings.terminal.behavior": "Behavior",
	"settings.terminal.startup": "Startup",
	"settings.terminal.theme": "Color theme",
	"settings.terminal.themeDesc": "Follow the app light/dark mode, or pin a fixed theme",
	"settings.terminal.theme.inherit": "Follow app appearance",
	"settings.terminal.paddingY": "Vertical padding",
	"settings.terminal.paddingYDesc": "Space between terminal content and panel edges (px)",
	"settings.terminal.fontSize": "Font size",
	"settings.terminal.fontSizeDesc": "Pick “Follow UI font size” to use the UI size from Appearance",
	"settings.terminal.fontSize.follow": "Follow UI font size",
	"settings.terminal.fontFamily": "Font family",
	"settings.terminal.fontFamilyDesc": "Pick from installed system fonts; “Follow code font” uses the code font from Appearance",
	"settings.terminal.fontFamily.follow": "Follow code font",
	"settings.terminal.fontFamilySearch": "Search fonts…",
	"settings.terminal.fontFamilyEmpty": "No matching font",
	"settings.terminal.fontFamilyMissing": "current value (not installed)",
	"settings.terminal.fontFamilyLoadFailed": "Could not read the system font list; only “Follow code font” is available for now.",
	"settings.terminal.scrollback": "Scrollback lines",
	"settings.terminal.scrollbackDesc": "Maximum retained history lines. Applies to newly opened terminals (shrinking discards history immediately, so it is not hot-updated)",
	...
	"settings.terminal.copyOnSelectDesc": "Copy selected terminal text to the system clipboard automatically",
	"settings.terminal.confirmClose": "Close confirmation",
	"settings.terminal.confirmCloseDesc": "When to confirm before closing a terminal tab",
	"settings.terminal.confirmClose.never": "Never",
	"settings.terminal.confirmClose.running": "Only when running",
	"settings.terminal.confirmClose.always": "Always",
	"settings.terminal.startupCommand": "Startup command",
	"settings.terminal.startupCommandDesc": "Run this command automatically after the shell starts in a new terminal",
	"settings.terminal.startupCommandPlaceholder": "e.g. cd ~/projects",
	"terminal.closeTabConfirm": "Close this terminal?",
	"terminal.closeTabConfirmDesc": "Commands may still be running in this terminal; closing will terminate them.",
	...
	"settings.updateSource": "Content Update Source",
	"settings.updateSourceDesc": "Choose the network channel for downloading content such as the model catalog, built-in extensions and the DSH runtime. AtomGit is recommended in China; GitHub official is also available. The app's own updates always use GitHub and are unaffected by this setting.",
	...
	"settings.updateSourceFeedPreview": "Current content update source URL: {url}",
	...
	"settings.updateGithubFailHint": "App updates always come from GitHub; if it is unreachable, download the installer from the Release page.",
